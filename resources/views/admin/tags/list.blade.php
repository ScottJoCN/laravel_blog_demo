		...
		<table class="am-table am-table-hover am-table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="{{URL::to('tag/'.$tag->id.'/edit')}}" title="" class="am-btn am-btn-xs am-btn-primary"><span class="am-icon-pencil"></span>Edit</a>
						<form action="{{URL::to('tag/'.$tag->id.'/delete')}}" method="get" accept-charset="utf-8" style="display:inline;">
							<button class="am-btn am-btn-xs am-btn-danger" id="delete{{$tag->id}}"><span class="am-icon-remove"></span>Delete</button>
						</form>
